...
<body>
    ...
    <div class="container my-5 border rounded p-5">
        ...
        <form class="mt-3" action="change-password-check.php" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="admin_to_edit" value="<?php echo $id; ?>">
            <div class="mb-3">
            ...
            <button type="submit" name="changeAdminPass" class="btn btn-primary">Change Password</button>
        </form>
    </div>
